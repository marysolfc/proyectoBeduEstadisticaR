# Poryecto final del curso de Bedu fase 2: programación y estadística con R
...
Pero dado que las variables ln_als y ln_alns están en logaritmo, necesitamos aplicar la función exponencial para obtener
